/**
 * Copyright (c) 2017-present, Boom Lee
 ...
 *
 * @providesModule VirtualizeList
 * @flow
 *
 * Ported from:
 * https://github.com/facebook/react-native/blob/d19afc73f5048f81656d0b4424232ce6d69a6368/Libraries/Lists/VirtualizedList.js
 */
...
import { shape, bool, number, checkPropTypes } from 'prop-types';
import flattenStyle from '../../apis/StyleSheet/flattenStyle';
import infoLog from '../../modules/Utilities/infoLog';
...
export type renderItemType = (info: any) => ?Element<any>;
...
type OptionalProps = {
   ...
   * a rendered element.
   */
  ListEmptyComponent?: ?(ComponentType<any> | Element<any>),
  /**
   * Rendered at the bottom of all the items. Can be a React Component Class, a render function, or
   * a rendered element.
   */
  ListFooterComponent?: ?(ComponentType<any> | Element<any>),
  /**
   * Rendered at the top of all the items. Can be a React Component Class, a render function, or
   * a rendered element.
   */
  ListHeaderComponent?: ?(ComponentType<any> | Element<any>),
  /**
   ...
   */
  renderScrollComponent?: (props: Object) => Element<any>,
  /**
...
class VirtualizedList extends React.PureComponent<Props, State> {
  ...
  _pushCells(
    ...
    first: number,
    last: number,
    inversionStyle: ?any, // StyleObj
  ) {
    const {
      CellRendererComponent,
      ItemSeparatorComponent, // eslint-disable-line
      data,
      getItem,
      getItemCount,
      horizontal,
  ...
  _onCellLayout(e: any, cellKey: any, index: number) {
...
> {
  ...
  render() {
    ...
    if (!CellRendererComponent) {
      return (
        <View onLayout={onLayout} style={cellStyle} >
          {element}
          {itemSeparator}
        </View>
      );
